        ...
        md:shadow-sm z-10  sticky block top-0 m-0 p-0 border-b border-b-gray-200">
            <div className="container flex w-auto justify-center items-center mx-auto">
                ...
                <div className={'md:h-full md:mr-4 md:bg-none md:border-none border-b border-b-gray-200 ' +
                    ...
                    <div className="flex justify-center space-x-2  ms:border-b-gray-200 md:p-0 md:m-0  shadow
                 w-full flex-row md:h-full md:shadow-none md:space-x-2 md:mt-0 md:text-sm
